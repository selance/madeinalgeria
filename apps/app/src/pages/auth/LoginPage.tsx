...
const LoginPage = () => {
  ...
  // own `redirect` param, so the login gate can send visitors back where they
    ...
    <section dir="rtl" className="flex h-dvh w-full gap-5 bg-neutral-50 p-5">
      <section className="mx-auto flex h-full w-full max-w-xl flex-col justify-center sm:px-8 sm:py-12 lg:px-10 lg:py-20">
        <div className="mx-auto w-full max-w-md lg:mx-0">
          ...
          <div className="mb-6">
            <h2 className="mb-2 text-2xl text-neutral-700 lg:text-[26px]">سجل الدخول الى حسابك</h2>
            <h4 className="text-lg text-neutral-500 lg:text-[20px]">مرحباً بعودتك من فضلك أدخل معلوماتك</h4>
          </div>
