...
export const ui = {
  en: {
    ...
    detail: {
      ...
      lastPush: "Last push",
      badgeTitle: "Add this badge to your README",
      badgeHint: "Show that your project is listed on Made in Algeria.",
    },
    hubs: {
      browseTitle: "Browse the directory",
      browseBody: "Explore projects by category, language, topic, or the developers behind them.",
      byCategory: "By category",
      byLanguage: "By language",
      byTopic: "Popular topics",
      byDeveloper: "Top developers",
      ...
      developersWord: "developers",
      topTitle: "Most starred projects",
      topDescription: "The most starred open-source projects built by Algerian developers.",
      newTitle: "Recently added projects",
      newDescription: "The latest open-source projects added to the directory.",
      categoryTitle: (name: string) => `${name} projects, made in Algeria`,
      categoryDescription: (name: string) =>
        `Open-source ${name} projects built by Algerian developers. Discover, star, and contribute.`,
      languageTitle: (name: string) => `${name} projects by Algerian developers`,
      languageDescription: (name: string) =>
        `Open-source ${name} projects built by Algerian developers, in one curated directory.`,
      topicTitle: (name: string) => `${name} projects, made in Algeria`,
      topicDescription: (name: string) =>
        `Open-source projects tagged "${name}", built by Algerian developers.`,
      developerHeading: (login: string) => `Projects by ${login}`,
      developerTitle: (login: string) => `${login}, projects on Made in Algeria`,
      developerDescription: (login: string) =>
        `Open-source projects by ${login}, an Algerian developer, listed on Made in Algeria.`,
      developersHeading: "Developers",
      developersIntro: "The Algerian developers behind the projects in the directory.",
      viewProfile: "View on GitHub",
      empty: "No projects here yet.",
      viewAll: "View all projects",
    },
    feed: {
      title: "New projects, Made in Algeria",
      description:
        "The latest open-source projects by Algerian developers, added to the directory.",
    ...
    hire: {
      title: "Work with Algerian developers",
      description:
        "Hire Algerian developers directly, or a managed team through Selance, the studio behind Made in Algeria.",
      heading: "Work with Algerian developers",
      intro:
        "Made in Algeria showcases the open-source work of Algeria's developer community. If you want to build with that talent, here is how it works.",
      whyTitle: "Why Algerian developers",
      why: "A large, fast-growing pool of engineers with strong fundamentals, French and English as working languages, and a timezone (GMT+1) that overlaps a full working day with Europe and part of the Americas.",
      howTitle: "Two ways to work together",
      independentTitle: "Hire independently",
      independentBody:
        "Browse the directory, find developers whose work fits, and reach out on GitHub. Open and free.",
      studioTitle: "Work with the studio",
      studioBody:
        "Prefer a managed team that scopes, builds, and ships? Selance, the studio behind Made in Algeria, staffs and delivers software projects with developers from this community.",
      ctaTitle: "Have something to build?",
      ctaBody: "Tell Selance what you need. No commitment, just a conversation.",
      cta: "Talk to Selance",
      browseCta: "Browse developers",
      disclosure:
        "Made in Algeria is built and operated by Selance. The directory is free and open; working with the studio is entirely optional.",
    },
    about: {
      title: "About",
    ...
    footer: {
      ...
      studioSuffix: ", a software studio.",
      studioTitle: "Selance, a software studio building products with Algeria's best developers.",
  ...
  ar: {
    ...
    detail: {
      ...
      lastPush: "آخر تحديث",
      badgeTitle: "أضف هذه الشارة إلى ملف README",
      badgeHint: "أظهر أن مشروعك مُدرج على «صُنع في الجزائر».",
    },
    hubs: {
      browseTitle: "تصفّح الدليل",
      browseBody: "استكشف المشاريع حسب التصنيف أو اللغة أو الموضوع أو المطوّرين الذين بنوها.",
      byCategory: "حسب التصنيف",
      byLanguage: "حسب اللغة",
      byTopic: "مواضيع شائعة",
      byDeveloper: "أبرز المطوّرين",
      ...
      projectsWord: "مشروع",
      developerWord: "مطوّر",
      developersWord: "مطوّر",
      topTitle: "الأكثر نجوماً",
      topDescription: "أكثر المشاريع مفتوحة المصدر نجوماً، بناها مطوّرون جزائريون.",
      newTitle: "أحدث المشاريع",
      newDescription: "آخر المشاريع مفتوحة المصدر المضافة إلى الدليل.",
      categoryTitle: (name: string) => `مشاريع ${name}، صُنعت في الجزائر`,
      categoryDescription: (name: string) =>
        `مشاريع ${name} مفتوحة المصدر بناها مطوّرون جزائريون. اكتشفها وساهم فيها.`,
      languageTitle: (name: string) => `مشاريع ${name} من مطوّرين جزائريين`,
      languageDescription: (name: string) =>
        `مشاريع ${name} مفتوحة المصدر بناها مطوّرون جزائريون، في دليل واحد منسّق.`,
      topicTitle: (name: string) => `مشاريع ${name}، صُنعت في الجزائر`,
      topicDescription: (name: string) =>
        `مشاريع مفتوحة المصدر موسومة بـ«${name}»، بناها مطوّرون جزائريون.`,
      developerHeading: (login: string) => `مشاريع ${login}`,
      developerTitle: (login: string) => `${login}، مشاريع على «صُنع في الجزائر»`,
      developerDescription: (login: string) =>
        `مشاريع مفتوحة المصدر للمطوّر الجزائري ${login}، مُدرجة على «صُنع في الجزائر».`,
      developersHeading: "المطوّرون",
      developersIntro: "المطوّرون الجزائريون الذين بنوا مشاريع الدليل.",
      viewProfile: "عرض على GitHub",
      empty: "لا توجد مشاريع هنا بعد.",
      viewAll: "عرض كل المشاريع",
    },
    feed: {
      title: "مشاريع جديدة، صُنعت في الجزائر",
      description: "آخر المشاريع مفتوحة المصدر من مطوّرين جزائريين، مضافة إلى الدليل.",
      subscribe: "اشترك عبر RSS",
    },
    breadcrumb: {
      home: "الرئيسية",
      projects: "المشاريع",
    ...
    hire: {
      title: "اعمل مع مطوّرين جزائريين",
      description:
        "وظّف مطوّرين جزائريين مباشرة، أو فريقاً مُداراً عبر Selance، الاستوديو خلف «صُنع في الجزائر».",
      heading: "اعمل مع مطوّرين جزائريين",
      intro:
        "يعرض «صُنع في الجزائر» أعمال مجتمع المطوّرين الجزائريين مفتوحة المصدر. إن أردت البناء مع هذه الكفاءات، إليك الطريقة.",
      whyTitle: "لماذا المطوّرون الجزائريون",
      why: "كفاءات هندسية كثيرة وسريعة النمو بأسس قوية، لغتا عمل فرنسية وإنجليزية، ومنطقة زمنية (GMT+1) تتداخل مع يوم عمل كامل في أوروبا وجزء من الأمريكتين.",
      howTitle: "طريقتان للعمل معاً",
      independentTitle: "التوظيف المباشر",
      independentBody:
        "تصفّح الدليل، اعثر على مطوّرين يناسبك عملهم، وتواصل معهم على GitHub. مفتوح ومجاني.",
      studioTitle: "العمل مع الاستوديو",
      studioBody:
        "تفضّل فريقاً مُداراً يحدّد النطاق ويبني ويسلّم؟ Selance، الاستوديو خلف «صُنع في الجزائر»، يشكّل الفرق ويسلّم مشاريع البرمجيات مع مطوّرين من هذا المجتمع.",
      ctaTitle: "لديك مشروع تبنيه؟",
      ctaBody: "أخبر Selance بما تحتاج. دون التزام، مجرّد محادثة.",
      cta: "تحدّث إلى Selance",
      browseCta: "تصفّح المطوّرين",
      disclosure:
        "«صُنع في الجزائر» بُني ويُدار من Selance. الدليل مجاني ومفتوح، والعمل مع الاستوديو اختياري تماماً.",
    },
    about: {
      title: "حول",
    ...
    footer: {
      ...
      builtBy: "تطوير",
      hire: "وظّف مطوّرين",
      studioSuffix: "، استوديو برمجيات.",
      studioTitle: "Selance، استوديو برمجيات يبني منتجات مع نخبة المطوّرين الجزائريين.",
