...
const CardsIcon = (props: React.ComponentProps<"svg">) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" {...props} className={cn("size-3 text-neutral-500", props.className)}  viewBox="0 0 256 256">
      <path
