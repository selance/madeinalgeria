...
const TableIcon = (props: React.ComponentProps<"svg">) => {
  return (
    <svg
      ...
      {...props}
      className={cn("size-3 text-neutral-500", props.className)}
      viewBox="0 0 256 256"
    >
      <path d="M224,64V192a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V64a8,8,0,0,1,8-8H216A8,8,0,0,1,224,64Z" opacity="0.2"></path>
